...
The `ggmap2` package currently contains the following functions:
  ...
  - `climograph`, a function to automatically produce a climograph of
    any region in the world. <!-- Add altitude -->
  ...
  - `ggRegression`, a function to produce maps of the slope, R²,
    Adjusted R² and p-Value of point-wise linear model based on a
    time-series raster
object.
